...
export default function Home() {
  ...
  const demoSequence: TerminalLine[] = [
    { type: 'bot', content: "Hi! I'm your Chancer AI developer. What would you like to build?" },
          ...
          <div className="border-b border-[#1a1a1a]">
            <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-[#666] text-sm font-mono">info@chancer.fun</div>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 rounded-full bg-green-500"></div>
                <span className="text-xs text-[#666]">AGENTS: 266 ACTIVE</span>
              </div>
            </div>
          </div>
                ...
                <div className="relative w-full">
                  ...
                  <div className="relative">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 font-mono text-center">
                      <span className="text-cyan-400">See Chancer Fun in Action </span>
                    </h1>
